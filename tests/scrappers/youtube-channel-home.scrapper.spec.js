...
const youtubeChannelHomeScrapper = require("../../src/scrappers/youtube-channel-home.scrapper");
...
// @todo: Implement scrapping logic tests for YouTube channel home page
describe("youtubeChannelHomeScrapper Scrapping Script", () => {
  test("Successfully Scraps YouTube Live data when a transmission is ongoing", async () => {
    ...
    const response = await youtubeChannelHomeScrapper("UCPqrEgBEHVj4vDITrClNQIw");
    const expectedData = {
